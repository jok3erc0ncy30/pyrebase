...
class Auth:
    ...
    def sign_in_with_email_and_password(self, email, password):
        ...
        return raise_detailed_error(request_object), request_object.json()
...
class Database:
    ...
    def set(self, data, token=None, json_kwargs={}):
        ...
        return request_object.json(), raise_detailed_error(request_object)
...
def raise_detailed_error(request_object):
    try:
        ...
        return HTTPError(e, request_object.text)
